  ...
  return (
    <div className="space-y-8 py-8 max-w-3xl mx-auto font-sans text-sm">
      ...
      <div className="space-y-4 text-[var(--n-graphite)] leading-relaxed">
        ...
        <h2 className="text-lg font-bold text-[var(--n-ink)]">2. Hermes Agent Conversations</h2>
        <p>
          When you interact with Hermes, your visitor name/role is used in-session for context. Message contents are processed through an API adapter to generate answers from curated portfolio knowledge. Raw chat messages are not sold, leaked, or indexed into private databases.
        </p>
